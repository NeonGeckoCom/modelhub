...
corpus_root = "/home/user/PycharmProjects/nlp_workspace/biblioteca/corpora/NER-datasets/Portuguese/Paramopama/corpus_First_HAREM.txt"
reader = postag_corpus(corpus_root)
training_samples = list(reader)
random.shuffle(training_samples)
corpus_root = "/home/user/PycharmProjects/nlp_workspace/biblioteca/corpora/NER-datasets/Portuguese/Paramopama/corpus_miniHAREM.txt"
reader = postag_corpus(corpus_root)
